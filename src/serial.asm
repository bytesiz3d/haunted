...
InitSerial     PROC     NEAR
        ...
        MOV     AL, 1Bh ;00011111         ;Access RT buffer, Disable Set Break, Even Parity, One Stop bit, 8 bits
       ; MOV     AL, 00011111b         ;Access RT buffer, Disable Set Break, Even Parity, One Stop bit, 8 bits
        OUT     DX, AL
